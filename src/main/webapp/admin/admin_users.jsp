...
Creating and editing users is now handled via modal dialogs.

    It is served by: AdminUserServlet (doGet).

    It submits to: AdminUserServlet (doPost from the modals).
	...
	<div class="modal-content">
		...
		<form id="user-modal-form"
			...
			<div class="form-group" id="password-group">
				<label for="password-modal">Passwort</label> <input type="password"
					id="password-modal" name="password" required> <small>Nur
					beim Erstellen oder Ändern erforderlich.</small>
			</div>
			<div class="form-group">
...
passwordGroup.style.display = 'none'; // Or just change the label/help text
