...
<p>Wählen Sie die Benutzer aus, die dem finalen Team für dieses Event angehören sollen.</p>
...
<div class="card">
    <form action="${pageContext.request.contextPath}/admin/events" method="post">
                ...
                <div class="user-checkbox-list">
                    <c:forEach var="user" items="${signedUpUsers}">
                        <label class="checkbox-label">
                            <%-- The name="userIds" is crucial. It creates an array of values. --%>
        ...
        <div style="margin-top: 2rem;">
            ...
            <a href="${pageContext.request.contextPath}/admin/events" class="btn" style="background-color: #6c757d;">Abbrechen</a>
        </div>
    </form>
</div>
