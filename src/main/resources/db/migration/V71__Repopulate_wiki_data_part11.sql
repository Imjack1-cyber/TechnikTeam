...
('src/main/java/de/technikteam/api/v1/public_api/PublicAnnouncementResource.java',
...
('src/main/java/de/technikteam/api/v1/public_api/PublicCalendarEntriesResource.java',
'## 1. File Overview & Purpose
...
('src/main/java/de/technikteam/api/v1/public_api/PublicChangelogResource.java',
'## 1. File Overview & Purpose
...
('src/main/java/de/technikteam/api/v1/public_api/PublicChatResource.java',
'## 1. File Overview & Purpose
