...
('src/main/java/de/technikteam/api/v1/AdminRequestResource.java',
...
('src/main/java/de/technikteam/api/v1/AdminStorageRelationsResource.java',
'## 1. File Overview & Purpose
...
('src/main/java/de/technikteam/api/v1/AdminTrainingRequestResource.java',
'## 1. File Overview & Purpose
...
('src/main/java/de/technikteam/api/v1/AdminVenueResource.java',
'## 1. File Overview & Purpose
...
('src/main/java/de/technikteam/api/v1/ChecklistResource.java',
'## 1. File Overview & Purpose
