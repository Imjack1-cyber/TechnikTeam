 ...
 * This class defines the application's security policies, such as which endpoints
 * are public and which require authentication, and integrates the custom JWT filter.
 */
@Configuration
@EnableWebSecurity
