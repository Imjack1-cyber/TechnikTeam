...
/*
 *  This class is responsible for managing the application's connection to the MySQL database. It uses the HikariCP connection pool for efficient performance, providing a static getConnection() method that all Data Access Objects (DAOs) use to communicate with the database.
 */
public class DatabaseManager {
	 ...
	 * borrows an existing connection, it doesn't create one.
	 * 
	...
	/**
	 * Closes the entire connection pool. This should be called when the application
	 * shuts down.
	 */
