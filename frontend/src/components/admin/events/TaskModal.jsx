	...
	return (
        ...
        >
            ...
            <View style={{flexDirection: 'row', alignItems: 'center', marginVertical: 16}}>
                 <BouncyCheckbox isChecked={dependsOnPrevious} onPress={(isChecked) => setDependsOnPrevious(isChecked)} fillColor={colors.primary} />
                <Text style={{color: colors.text}}>Hängt von vorheriger Aufgabe ab</Text>
            </View>
